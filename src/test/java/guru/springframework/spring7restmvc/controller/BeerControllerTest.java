...
class BeerControllerTest {
    ...
    void testCreateBeerNullBeerName() throws Exception {
        ...
        given(beerService.saveNewBeer(any())).willReturn(beerServiceImpl.beerList(null).get(1));
    ...
    void testCreateNewBeer() throws Exception {
        BeerDTO beer = beerServiceImpl.beerList(null).get(0);
    ...
    void testListBeers() throws Exception {
        List<BeerDTO> beerList = beerServiceImpl.beerList(null);

        given(beerService.beerList(null)).willReturn(beerList);
